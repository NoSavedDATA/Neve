...
/// numberexpr ::= number
std::unique_ptr<ExprAST> ParseNumberExpr(Parser_Struct *parser_struct, bool is_double_dot=false, bool is_inf=false);
std::unique_ptr<ExprAST> ParseIntExpr(Parser_Struct *parser_struct, bool is_double_dot=false, bool is_inf=false);
