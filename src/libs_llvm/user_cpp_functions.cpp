...
void set_user_functions() {
    ...
    user_cpp_functions = {"printtt",
		...
		"nullptr_get", "is_null", 
		"array_Create", "array_clone", "array_slice", "array_pop", "array_size", "array_bad_idx", "array_double_size", "array_clear", "array_int_NewVec", "array_float_NewVec", "array_void_NewVec", "array_print_int", "array_print_char", "arange_int", "zeros_int", "randint_array", "ones_int", "array_int_add", "randfloat_array", "array_print_float", "arange_float", "zeros_float", "ones_float", "array_sum_int", "array_prod_int", "array_Split_Parallel", "array_print_str", "array_shuffle_str", "hash_array_int", "array_eq_int", 
		...
		"str_eq", "str_str_add", "str_float", "str_int_add", "str_float_add", "int_str_add", "float_str_add", "str_bool_add", "bool_str_add", "PrintStr", "cat_str_float", "str_split_idx", "can_convert_to_float", "str_to_float", "str_str_different", "str_str_equal", "str_Delete", "readline", "_glob_b_", 
		...
		"map_Create", "map_node_reclaim", "hash_ptr", "map_size", "map_expand", "map_has_str", "map_has_void_ptr", "map_has_int", "map_has_i64", "map_get_str_int", "map_get_i64_any", "map_get_i64_int", "map_has_float", "map_has_char", "print_str", "map_print", "map_node_set_bucket", "map_node_set_next", "map_node_overwrite_bucket", "map_node_overwrite", "map_keys_str", "map_keys_void_ptr", "map_keys_array", "map_keys_i64", "map_keys", "map_values", "map_values_int", "map_bad_key_str", "map_bad_key_void_ptr", "map_bad_key_int", "map_bad_key_i64", "map_bad_key_array", "map_bad_key_float", "map_clear", 
