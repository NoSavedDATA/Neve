...
void set_user_functions() {
    ...
    user_cpp_functions = {"printtt",
		...
		"channel_Create", "str_channel_message", "channel_str_message", "str_channel_Idx", "str_channel_terminate", "str_channel_alive", "float_channel_terminate", "float_channel_alive", "int_channel_message", "channel_int_message", "int_channel_Idx", "int_channel_sum", "int_channel_terminate", "int_channel_alive", 
